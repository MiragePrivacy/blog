...
date: "2025-08-22"
tags: ["announcement", "azoth"]
author: "Samuel Alake"
image: "../assets/2025-08-22-introducing-azoth/azoth.jpg"
---
...
#### 2.3. Shuffle (block‑level)

This is a simple block-level randomization that changes program layout without affecting execution. For example, `0x60015b6002` -> `0x5b60026001`. As of now, itdoes not shuffle instructions inside a block yet (that’s planned).

#### 2.4. Jump Address Transformer
